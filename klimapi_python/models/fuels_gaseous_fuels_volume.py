...
class FuelsGaseousFuelsVolume(BaseModel):
    """
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['butane', 'cng', 'lng', 'lpg', 'other_petroleum_gas', 'propane', 'average', 'natural_gas', 'natural_gas_100%_mineral_blend', 'average']):
            raise ValueError("must be one of enum values ('butane', 'cng', 'lng', 'lpg', 'other_petroleum_gas', 'propane', 'average', 'natural_gas', 'natural_gas_100%_mineral_blend', 'average')")
        return value
