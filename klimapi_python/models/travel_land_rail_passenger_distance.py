...
class TravelLandRailPassengerDistance(BaseModel):
    """
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['national_rail', 'international_rail', 'light_rail_and_tram', 'average']):
            raise ValueError("must be one of enum values ('national_rail', 'international_rail', 'light_rail_and_tram', 'average')")
        return value
