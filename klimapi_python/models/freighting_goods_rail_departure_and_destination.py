...
class FreightingGoodsRailDepartureAndDestination(BaseModel):
    """
    FreightingGoodsRailDepartureAndDestination
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'rail'
    specification: Optional[StrictStr] = 'freight_train'
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['freight_train']):
            raise ValueError("must be one of enum values ('freight_train')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'rail',
            "specification": obj.get("specification") if obj.get("specification") is not None else 'freight_train',
