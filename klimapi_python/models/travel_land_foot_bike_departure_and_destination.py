...
class TravelLandFootBikeDepartureAndDestination(BaseModel):
    """
    TravelLandFootBikeDepartureAndDestination
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'foot_bike'
    ...
    __properties: ClassVar[List[str]] = ["type", "activity", "departure", "destination", "return_trip", "passengers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'foot_bike',
