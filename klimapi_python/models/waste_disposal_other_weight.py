...
class WasteDisposalOtherWeight(BaseModel):
    """
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['books', 'glass', 'clothing', 'average']):
            raise ValueError("must be one of enum values ('books', 'glass', 'clothing', 'average')")
        return value
    ...
    def detail_validate_enum(cls, value):
        ...
        if value not in set(['closed-loop', 'combustion', 'composting', 'landfill', 'average', 'open-loop']):
            raise ValueError("must be one of enum values ('closed-loop', 'combustion', 'composting', 'landfill', 'average', 'open-loop')")
        return value
