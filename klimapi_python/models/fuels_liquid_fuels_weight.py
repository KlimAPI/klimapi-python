...
class FuelsLiquidFuelsWeight(BaseModel):
    """
    FuelsLiquidFuelsWeight
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'liquid_fuels'
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['aviation_spirit', 'aviation_turbine_fuel', 'burning_oil', 'diesel_average_biofuel_blend', 'diesel_100%_mineral_diesel', 'fuel_oil', 'gas_oil', 'lubricants', 'naphtha', 'petrol_average_biofuel_blend', 'petrol_100%_mineral_petrol', 'processed_fuel_oils-residual_oil', 'processed_fuel_oils-distillate_oil', 'waste_oils', 'marine_gas_oil', 'marine_fuel_oil', 'average']):
            raise ValueError("must be one of enum values ('aviation_spirit', 'aviation_turbine_fuel', 'burning_oil', 'diesel_average_biofuel_blend', 'diesel_100%_mineral_diesel', 'fuel_oil', 'gas_oil', 'lubricants', 'naphtha', 'petrol_average_biofuel_blend', 'petrol_100%_mineral_petrol', 'processed_fuel_oils-residual_oil', 'processed_fuel_oils-distillate_oil', 'waste_oils', 'marine_gas_oil', 'marine_fuel_oil', 'average')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'liquid_fuels',
