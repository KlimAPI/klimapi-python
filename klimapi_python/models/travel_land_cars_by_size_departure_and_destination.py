...
class TravelLandCarsBySizeDepartureAndDestination(BaseModel):
    """
    TravelLandCarsBySizeDepartureAndDestination
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'cars_by_size'
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['small_car', 'medium_car', 'large_car', 'average']):
            raise ValueError("must be one of enum values ('small_car', 'medium_car', 'large_car', 'average')")
        return value
    ...
    def detail_validate_enum(cls, value):
        ...
        if value not in set(['diesel', 'petrol', 'hybrid', 'plug-in_hybrid_electric_vehicle', 'battery_electric_vehicle', 'average', 'cng', 'lpg']):
            raise ValueError("must be one of enum values ('diesel', 'petrol', 'hybrid', 'plug-in_hybrid_electric_vehicle', 'battery_electric_vehicle', 'average', 'cng', 'lpg')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'cars_by_size',
