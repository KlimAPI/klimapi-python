...
class InfrastructureRealEstateCurrency(BaseModel):
    """
    InfrastructureRealEstateCurrency
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'real_estate'
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['infrastructure']):
            raise ValueError("must be one of enum values ('infrastructure')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'real_estate',
