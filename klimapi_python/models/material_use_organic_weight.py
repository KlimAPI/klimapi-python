...
class MaterialUseOrganicWeight(BaseModel):
    """
    MaterialUseOrganicWeight
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'organic'
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['compost_derived_from_garden_waste', 'compost_derived_from_food_and_garden_waste', 'average']):
            raise ValueError("must be one of enum values ('compost_derived_from_garden_waste', 'compost_derived_from_food_and_garden_waste', 'average')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'organic',
