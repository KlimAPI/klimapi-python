...
class BioenergyBiomassWeight(BaseModel):
    """
    BioenergyBiomassWeight
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'biomass'
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['wood_logs', 'wood_chips', 'wood_pellets', 'grass/straw', 'average']):
            raise ValueError("must be one of enum values ('wood_logs', 'wood_chips', 'wood_pellets', 'grass/straw', 'average')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'biomass',
