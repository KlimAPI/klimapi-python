...
class MaterialUseTextilesCurrency(BaseModel):
    """
    MaterialUseTextilesCurrency
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'textiles'
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['pl', 'pt', 'ro', 'at', 'au', 'be', 'bg', 'br', 'ca', 'ch', 'cn', 'cy', 'cz', 'de', 'dk', 'ee', 'es', 'fi', 'fr', 'gb', 'gr', 'hr', 'hu', 'id', 'ie', 'in', 'it', 'jp', 'kr', 'lt', 'lu', 'lv', 'mt', 'mx', 'nl', 'no', 'ru', 'se', 'si', 'sk', 'tr', 'tw', 'us', 'za', 'average']):
            raise ValueError("must be one of enum values ('pl', 'pt', 'ro', 'at', 'au', 'be', 'bg', 'br', 'ca', 'ch', 'cn', 'cy', 'cz', 'de', 'dk', 'ee', 'es', 'fi', 'fr', 'gb', 'gr', 'hr', 'hu', 'id', 'ie', 'in', 'it', 'jp', 'kr', 'lt', 'lu', 'lv', 'mt', 'mx', 'nl', 'no', 'ru', 'se', 'si', 'sk', 'tr', 'tw', 'us', 'za', 'average')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'textiles',
