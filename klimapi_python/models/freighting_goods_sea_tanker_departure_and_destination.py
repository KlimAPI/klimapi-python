...
class FreightingGoodsSeaTankerDepartureAndDestination(BaseModel):
    """
    FreightingGoodsSeaTankerDepartureAndDestination
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'sea_tanker'
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['crude_tanker', 'products_tanker', 'chemical_tanker', 'lng_tanker', 'lpg_tanker', 'average']):
            raise ValueError("must be one of enum values ('crude_tanker', 'products_tanker', 'chemical_tanker', 'lng_tanker', 'lpg_tanker', 'average')")
        return value
    ...
    def detail_validate_enum(cls, value):
        ...
        if value not in set(['200,000+_dwt', '120,000–199,999_dwt', '80,000–119,999_dwt', '60,000–79,999_dwt', '10,000–59,999_dwt', '0–9999_dwt', 'average', '60,000+_dwt', '20,000–59,999_dwt', '10,000–19,999_dwt', '5000–9999_dwt', '0–4999_dwt', '20,000+_dwt', '200,000+_m3', '0–199,999_m3', '50,000+_m3', '0–49,999_m3']):
            raise ValueError("must be one of enum values ('200,000+_dwt', '120,000–199,999_dwt', '80,000–119,999_dwt', '60,000–79,999_dwt', '10,000–59,999_dwt', '0–9999_dwt', 'average', '60,000+_dwt', '20,000–59,999_dwt', '10,000–19,999_dwt', '5000–9999_dwt', '0–4999_dwt', '20,000+_dwt', '200,000+_m3', '0–199,999_m3', '50,000+_m3', '0–49,999_m3')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'sea_tanker',
