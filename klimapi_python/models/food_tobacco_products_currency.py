...
class FoodTobaccoProductsCurrency(BaseModel):
    """
    FoodTobaccoProductsCurrency
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'tobacco_products'
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['at', 'au', 'be', 'bg', 'br', 'ca', 'ch', 'cn', 'cy', 'cz', 'de', 'dk', 'es', 'fr', 'gb', 'gr', 'hr', 'hu', 'id', 'in', 'it', 'jp', 'kr', 'lt', 'lu', 'lv', 'mt', 'mx', 'nl', 'no', 'pl', 'pt', 'ro', 'ru', 'sk', 'tr', 'tw', 'us', 'za', 'average']):
            raise ValueError("must be one of enum values ('at', 'au', 'be', 'bg', 'br', 'ca', 'ch', 'cn', 'cy', 'cz', 'de', 'dk', 'es', 'fr', 'gb', 'gr', 'hr', 'hu', 'id', 'in', 'it', 'jp', 'kr', 'lt', 'lu', 'lv', 'mt', 'mx', 'nl', 'no', 'pl', 'pt', 'ro', 'ru', 'sk', 'tr', 'tw', 'us', 'za', 'average')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'tobacco_products',
