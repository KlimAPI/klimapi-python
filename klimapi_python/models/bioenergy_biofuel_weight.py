...
class BioenergyBiofuelWeight(BaseModel):
    """
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['bioethanol', 'biodiesel_me', 'biomethane_compressed', 'biodiesel_me_from_used_cooking_oil', 'biodiesel_me_from_tallow', 'biodiesel_hvo', 'biopropane', 'development_diesel', 'development_petrol', 'off_road_biodiesel', 'biomethane_liquified', 'methanol_bio', 'avtur_renewable', 'average']):
            raise ValueError("must be one of enum values ('bioethanol', 'biodiesel_me', 'biomethane_compressed', 'biodiesel_me_from_used_cooking_oil', 'biodiesel_me_from_tallow', 'biodiesel_hvo', 'biopropane', 'development_diesel', 'development_petrol', 'off_road_biodiesel', 'biomethane_liquified', 'methanol_bio', 'avtur_renewable', 'average')")
        return value
