...
class FoodFoodProductsNotElsewhereSpecifiedCurrency(BaseModel):
    """
    FoodFoodProductsNotElsewhereSpecifiedCurrency
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'food_products_not_elsewhere_specified'
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'food_products_not_elsewhere_specified',
