...
class TravelLandTaxisPassengerDistance(BaseModel):
    """
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['black_cab', 'regular_taxi', 'average']):
            raise ValueError("must be one of enum values ('black_cab', 'regular_taxi', 'average')")
        return value
