...
class WasteDisposalPaperWeight(BaseModel):
    """
    ...
    def detail_validate_enum(cls, value):
        ...
        if value not in set(['closed-loop', 'combustion', 'composting', 'landfill', 'average']):
            raise ValueError("must be one of enum values ('closed-loop', 'combustion', 'composting', 'landfill', 'average')")
        return value
