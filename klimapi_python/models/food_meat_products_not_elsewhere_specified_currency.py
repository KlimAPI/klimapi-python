...
class FoodMeatProductsNotElsewhereSpecifiedCurrency(BaseModel):
    """
    FoodMeatProductsNotElsewhereSpecifiedCurrency
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'meat_products_not_elsewhere_specified'
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['food']):
            raise ValueError("must be one of enum values ('food')")
        return value
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['at', 'au', 'be', 'bg', 'br', 'ca', 'ch', 'cn', 'cy', 'cz', 'de', 'dk', 'ee', 'es', 'fi', 'fr', 'gb', 'gr', 'hr', 'hu', 'id', 'ie', 'in', 'it', 'jp', 'kr', 'lt', 'lu', 'lv', 'mt', 'mx', 'nl', 'no', 'pl', 'pt', 'ro', 'ru', 'se', 'si', 'sk', 'tr', 'tw', 'us', 'za', 'average']):
            raise ValueError("must be one of enum values ('at', 'au', 'be', 'bg', 'br', 'ca', 'ch', 'cn', 'cy', 'cz', 'de', 'dk', 'ee', 'es', 'fi', 'fr', 'gb', 'gr', 'hr', 'hu', 'id', 'ie', 'in', 'it', 'jp', 'kr', 'lt', 'lu', 'lv', 'mt', 'mx', 'nl', 'no', 'pl', 'pt', 'ro', 'ru', 'se', 'si', 'sk', 'tr', 'tw', 'us', 'za', 'average')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'meat_products_not_elsewhere_specified',
