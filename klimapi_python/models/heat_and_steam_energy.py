...
class HeatAndSteamEnergy(BaseModel):
    """
    HeatAndSteamEnergy
    """ # noqa: E501
    type: StrictStr
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['heat_and_steam']):
            raise ValueError("must be one of enum values ('heat_and_steam')")
        return value
    ...
    def activity_validate_enum(cls, value):
        ...
        if value not in set(['onsite_heat_and_steam', 'district_heat_and_steam', 'average']):
            raise ValueError("must be one of enum values ('onsite_heat_and_steam', 'district_heat_and_steam', 'average')")
        return value
