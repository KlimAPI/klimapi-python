...
class CloudComputingStorageTbHour(BaseModel):
    """
    CloudComputingStorageTbHour
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'storage'
    ...
    unit: Optional[StrictStr] = Field(default='tb-hour', description="Need another unit? Contact us!")
    ...
    def unit_validate_enum(cls, value):
        ...
        if value not in set(['tb-hour']):
            raise ValueError("must be one of enum values ('tb-hour')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'storage',
            ...
            "value": obj.get("value"),
            "unit": obj.get("unit") if obj.get("unit") is not None else 'tb-hour'
        })
        return _obj
