...
class LinkByPriceRequest(BaseModel):
    """
    LinkByPriceRequest
    """ # noqa: E501
    price_amount: Union[Annotated[float, Field(strict=True, ge=0.5)], Annotated[int, Field(strict=True, ge=1)]] = Field(description="The total of the compensation in your given currency **incl. VAT**. Minimum order is 0.5 in your given currency.")
    ...
    __properties: ClassVar[List[str]] = ["price_amount", "change_allowed", "success_url", "cancel_url", "order_count", "metadata", "payment_type"]
