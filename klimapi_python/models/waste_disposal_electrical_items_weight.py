...
class WasteDisposalElectricalItemsWeight(BaseModel):
    """
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['weee-fridges_and_freezers', 'weee-large', 'weee-mixed', 'weee-small', 'batteries', 'average']):
            raise ValueError("must be one of enum values ('weee-fridges_and_freezers', 'weee-large', 'weee-mixed', 'weee-small', 'batteries', 'average')")
        return value
    ...
    def detail_validate_enum(cls, value):
        ...
        if value not in set(['open-loop', 'landfill', 'average', 'combustion']):
            raise ValueError("must be one of enum values ('open-loop', 'landfill', 'average', 'combustion')")
        return value
