...
class MaterialUseConstructionWeight(BaseModel):
    """
    MaterialUseConstructionWeight
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'construction'
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['aggregates', 'asbestos', 'asphalt', 'bricks', 'concrete', 'insulation', 'metals', 'soils', 'mineral_oil', 'plasterboard', 'tyres', 'wood', 'average']):
            raise ValueError("must be one of enum values ('aggregates', 'asbestos', 'asphalt', 'bricks', 'concrete', 'insulation', 'metals', 'soils', 'mineral_oil', 'plasterboard', 'tyres', 'wood', 'average')")
        return value
    ...
    def detail_validate_enum(cls, value):
        ...
        if value not in set(['primary_material_production', 're-used', 'closed-loop_source', 'average']):
            raise ValueError("must be one of enum values ('primary_material_production', 're-used', 'closed-loop_source', 'average')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'construction',
