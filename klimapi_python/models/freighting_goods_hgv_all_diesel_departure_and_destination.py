...
class FreightingGoodsHgvAllDieselDepartureAndDestination(BaseModel):
    """
    FreightingGoodsHgvAllDieselDepartureAndDestination
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'hgv_all_diesel'
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'hgv_all_diesel',
