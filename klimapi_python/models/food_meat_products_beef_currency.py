...
class FoodMeatProductsBeefCurrency(BaseModel):
    """
    FoodMeatProductsBeefCurrency
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'meat_products_beef'
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'meat_products_beef',
