...
class TravelLandBusDepartureAndDestination(BaseModel):
    """
    TravelLandBusDepartureAndDestination
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'bus'
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['local_bus', 'average_local_bus', 'coach', 'average']):
            raise ValueError("must be one of enum values ('local_bus', 'average_local_bus', 'coach', 'average')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'bus',
