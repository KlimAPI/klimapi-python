...
class MaterialUsePlasticWeight(BaseModel):
    """
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['plastics:pet_incl._forming', 'plastics:average_plastics', 'plastics:average_plastic_film', 'plastics:average_plastic_rigid', 'plastics:hdpe_incl._forming', 'plastics:ldpe_and_lldpe_incl._forming', 'plastics:pp_incl._forming', 'plastics:ps_incl._forming', 'plastics:pvc_incl._forming', 'average']):
            raise ValueError("must be one of enum values ('plastics:pet_incl._forming', 'plastics:average_plastics', 'plastics:average_plastic_film', 'plastics:average_plastic_rigid', 'plastics:hdpe_incl._forming', 'plastics:ldpe_and_lldpe_incl._forming', 'plastics:pp_incl._forming', 'plastics:ps_incl._forming', 'plastics:pvc_incl._forming', 'average')")
        return value
    ...
    def detail_validate_enum(cls, value):
        ...
        if value not in set(['closed-loop_source', 'primary_material_production', 'average']):
            raise ValueError("must be one of enum values ('closed-loop_source', 'primary_material_production', 'average')")
        return value
