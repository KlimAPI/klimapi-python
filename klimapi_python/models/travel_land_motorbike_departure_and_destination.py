...
class TravelLandMotorbikeDepartureAndDestination(BaseModel):
    """
    TravelLandMotorbikeDepartureAndDestination
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'motorbike'
    ...
    __properties: ClassVar[List[str]] = ["type", "activity", "specification", "departure", "destination", "return_trip"]
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['small', 'medium', 'large', 'average']):
            raise ValueError("must be one of enum values ('small', 'medium', 'large', 'average')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'motorbike',
