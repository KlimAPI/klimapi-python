...
class BioenergyBiogasEnergy(BaseModel):
    """
    BioenergyBiogasEnergy
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'biogas'
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['landfill_gas', 'average']):
            raise ValueError("must be one of enum values ('landfill_gas', 'average')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'biogas',
