...
class CheckoutLink(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["payment_link", "payment_link_id", "certificate_issued_at", "certificate_url", "certificate_pdf", "order_id", "kgCO2e", "price", "currency", "payment_received", "project"]
