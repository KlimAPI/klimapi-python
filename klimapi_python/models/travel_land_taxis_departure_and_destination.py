...
class TravelLandTaxisDepartureAndDestination(BaseModel):
    """
    TravelLandTaxisDepartureAndDestination
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'taxis'
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['regular_taxi', 'black_cab', 'average']):
            raise ValueError("must be one of enum values ('regular_taxi', 'black_cab', 'average')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'taxis',
