...
class FuelsSolidFuelsWeight(BaseModel):
    """
    FuelsSolidFuelsWeight
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'solid_fuels'
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['coal_industrial', 'coal_electricity_generation', 'coal_domestic', 'coking_coal', 'petroleum_coke', 'coal_electricity_generation-home_produced_coal_only', 'average']):
            raise ValueError("must be one of enum values ('coal_industrial', 'coal_electricity_generation', 'coal_domestic', 'coking_coal', 'petroleum_coke', 'coal_electricity_generation-home_produced_coal_only', 'average')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'solid_fuels',
