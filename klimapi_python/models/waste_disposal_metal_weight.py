...
class WasteDisposalMetalWeight(BaseModel):
    """
    WasteDisposalMetalWeight
    """ # noqa: E501
    type: StrictStr
    activity: Optional[StrictStr] = 'metal'
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['metal:aluminium_cans_and_foil_excl._forming', 'metal:mixed_cans', 'metal:scrap_metal', 'metal:steel_cans', 'average']):
            raise ValueError("must be one of enum values ('metal:aluminium_cans_and_foil_excl._forming', 'metal:mixed_cans', 'metal:scrap_metal', 'metal:steel_cans', 'average')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "activity": obj.get("activity") if obj.get("activity") is not None else 'metal',
