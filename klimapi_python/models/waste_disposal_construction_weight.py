...
class WasteDisposalConstructionWeight(BaseModel):
    """
    ...
    def specification_validate_enum(cls, value):
        ...
        if value not in set(['metals', 'aggregates', 'asbestos', 'asphalt', 'bricks', 'concrete', 'insulation', 'soils', 'mineral_oil', 'plasterboard', 'tyres', 'wood', 'average']):
            raise ValueError("must be one of enum values ('metals', 'aggregates', 'asbestos', 'asphalt', 'bricks', 'concrete', 'insulation', 'soils', 'mineral_oil', 'plasterboard', 'tyres', 'wood', 'average')")
        return value
    ...
    def detail_validate_enum(cls, value):
        ...
        if value not in set(['landfill', 'closed-loop', 'average', 'open-loop', 'combustion', 'composting']):
            raise ValueError("must be one of enum values ('landfill', 'closed-loop', 'average', 'open-loop', 'combustion', 'composting')")
        return value
