...
class TestCheckoutLinkCalculated(unittest.TestCase):
    """CheckoutLinkCalculated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckoutLinkCalculated:
        """Test CheckoutLinkCalculated
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckoutLinkCalculated`
        """
        model = CheckoutLinkCalculated()
        if include_optional:
            return CheckoutLinkCalculated(
                payment_link = '',
                payment_link_id = '',
    ...
    def testCheckoutLinkCalculated(self):
        """Test CheckoutLinkCalculated"""
